...
// const CategoryCard = ({
//   category,
//   props: { id, name, image, dPrice, price, discount },
//   showSize = false
// }) => {
...
//       <div>
//         <img src={image} alt={category} className="hover:scale-105 h-64 w-full object-cover rounded-lg" />
...
// export const FashionCard = (props) => <CategoryCard props={props} category="fashion" showSize={true} />;
// export const ElectronicsCard = (props) => <CategoryCard props={props} category="electronics" />;
// export const SpectaclesCard = (props) => <CategoryCard props={props} category="spectacles" />;
// export const GroceryCard = (props) => <CategoryCard props={props} category="grocery" />;
// export const BeautyCard = (props) => <CategoryCard props={props} category="beauty" />;
// export const SportsCard = (props) => <CategoryCard props={props} category="sports" />;
...
//       price,
//       discount,
//       ...(showSize && { size: selectedSize })  // Only include size if showSize is true
//     };
...
// // Category-specific wrappers for reuse
// export const FashionCard = (props) => (
//   <CategoryCard {...props} category="fashion" showSize={true} />
// );

// export const ElectronicsCard = (props) => (
//   <CategoryCard {...props} category="electronics" />
// );

// export const SpectaclesCard = (props) => (
//   <CategoryCard {...props} category="spectacles" />
// );

// export const GroceryCard = (props) => (
//   <CategoryCard {...props} category="grocery" />
// );

// export const BeautyCard = (props) => (
//   <CategoryCard {...props} category="beauty" />
// );

// export const SportsCard = (props) => (
//   <CategoryCard {...props} category="sports" />
// );
