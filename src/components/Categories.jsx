...
// import allProducts from './datasets/categoryData'; // Product dataset
...
//                             className={`flex justify-between items-center px-3 py-2 font-semibold cursor-pointer ${categoryName === path ? 'text-blue-600' : 'text-gray-800'
//                                 }`}
//                         >
//                             {name}
//                             <img
...
//                                         className={`text-sm px-2 border rounded border-gray-200 py-1 cursor-pointer mb-1 ${selectedSubcategories.includes(sub)
...
//                                     className={'border flex justify-center cursor-pointer items-center p-2 font-semibold hover:bg-gray-200 border-gray-400 rounded w-full'}
//                                 >
//                                     Add to Cart
//                                 </button>
//                                 <NavLink
